...
отзывчивого дизайна» («Responsive Design Workflow»)][1], книга опубликована
издательством New Riders.
...
и, иногда, об их технологических возможностях. Возможности устройств
...
множество вдохновляющих книг и ресурсов, чтобы запустить ваш внутренний
...
[Рисунок 7.6]: img/ch07-06_full.png "Большинству сайтов требуется гораздо меньше контрольных точек"
[Рисунок 7.7]: img/ch07-07_full.png "Существует несколько различных типов таблиц и различные способы адаптировать их для небольших экранов."
[Рисунок 7.8]: img/ch07-08_full.png "Один из вариантов адаптации таблиц для небольших экранов — представить каждую строку таблицы в виде блока."
